...
export default function VisitedPanel({
  ...
  return (
    <div className="flex flex-row xl:flex-col fixed bottom-0 left-0 right-0 xl:left-auto xl:right-4 xl:top-4 xl:bottom-4 xl:w-72 h-20 xl:h-auto bg-zinc-900/95 xl:bg-zinc-900/70 backdrop-blur-md border-t xl:border border-zinc-800 xl:rounded-2xl overflow-hidden z-20">
      <div className="flex-shrink-0 flex flex-col justify-center px-4 xl:p-4 border-r xl:border-r-0 xl:border-b border-zinc-800/50 bg-zinc-900/50">
        <h2 className="text-[10px] xl:text-xs uppercase tracking-widest font-semibold text-zinc-400">
          History
        </h2>
        <p className="hidden xl:block text-[10px] text-zinc-500 mt-1">
